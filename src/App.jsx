...
const LoginPage = () => {
  ...
  // Role information with user names
  const roleInfo = {
    admin: { 
      label: 'Admin', 
      ...
      userName: 'ad',
      defaultCreds: { username: 'ad', password: '1234' }
    },
    lender: { 
      label: 'Lender', 
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Current Role Display with User Name */}
            <div className={`bg-gradient-to-r ${roleInfo[selectedRole].color} rounded-xl p-4 text-white`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-90">{roleInfo[selectedRole].userName}</p>
                </div>
              </div>
            </div>
